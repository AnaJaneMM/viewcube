...
class CubeViewer(QWidget):
    ...
    def __init__(self, name_fits, **kwargs):
        try:
            ...
            # Crear layout principal primero
            self.main_layout = QVBoxLayout()
            self.setLayout(self.main_layout)
            
            # Inicializar widgets como None
            self.spaxel_widget = None
            ...
            if self.spaxel_widget and self.spectrum_widget:
            ...
            if self.name_fits:
                QTimer.singleShot(100, self.load_data)  # Retrasar la carga de datos
    ...
    def setup_spaxel_widget(self):
        ...
        try:
            if self.spaxel_widget is not None:
                self.spaxel_widget.deleteLater()
            ...
            # Configurar el widget para manejar memoria
            self.spaxel_widget.setAttribute(Qt.WA_DeleteOnClose)
    ...
    def setup_spectral_widget(self):
        ...
        try:
            ...
            # Configurar el widget para manejar memoria
            self.spectrum_widget.setAttribute(Qt.WA_DeleteOnClose)
